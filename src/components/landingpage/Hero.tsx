    ...
    return (
        <div className="relative overflow-hidden bg-zinc-50">
              ...
              <div className="mx-auto max-w-7xl">
                <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                  <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                    <div>
                      <h2 className="text-xl font-bold text-black">{"Wanderausstellung über"}</h2>
                  ...
                  <div className="my-8 sm:mt-24 lg:my-auto lg:col-span-6">
                    <div className="flex flex-col-reverse lg:flex-col bg-white border-zinc-200 sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden">
                      <div className='p-8'>
                        <p className="pb-3 font-bold text-s leading-5 text-zinc-500">{"Jetzt auf der Suche nach neuen Kooperationspartner:innen!"}</p>
          ...
          <div className="w-full bg-white">
                <div className="py-20 max-w-5xl px-6 mx-auto flex justify-center flex-wrap gap-x-24 gap-y-8">
